...
scRNA-seq data for the antigen-induced arthritis mouse model of rheumatoid arthritis can be downloaded from [Gene Expression Omnibus](https://www.ncbi.nlm.nih.gov/geo/) (GEO) using accessionnumber GSE193536. Meta-data can be found on figshare [10.6084/m9.figshare.21785333](10.6084/m9.figshare.21785333).

scRNA-seq data for multiple sclerosis patients were retrieved from GEO (GSE138266)[^2]. Meta-data can be found on [figshare](https://figshare.com/s/d75d0136702ba324c1d2).
