...
#setwd("/data/samsc76/SIGMA_13012020/Doctis_data_v3/R")
...
degs <- as.matrix(read.table(file = "../Output/DCA_MAST_DEGs/SUMMARY_MAST_DEGs_all_clusters_R_TRANSLATED.txt", header = T, stringsAsFactors = F, sep = "\t"))
if(nrow(degs)>3000){
  degs <- degs[1:3000,]
}
