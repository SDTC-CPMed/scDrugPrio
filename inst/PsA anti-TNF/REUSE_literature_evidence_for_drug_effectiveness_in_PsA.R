...
# anti-TNF responders
old_lit <- as.matrix(read_xlsx(path = "../Output/Final_ranking/Responder/FINAL_drug_ranking_Responder_evaluated.xlsx", sheet = 1, col_names = T))
old_lit <- old_lit[,c(1,2,10:12)]
old_lit2 <- as.matrix(read_xlsx(path = "../../Doctis_anti_IL17_v3 all drugs/Output/Final_ranking/Responder/FINAL_drug_ranking_Responder_evaluated.xlsx", sheet = 1, col_names = T))
...
old_lit2 <- as.matrix(read_xlsx(path = "../../Doctis_anti_IL17_v3 all drugs/Output/Final_ranking/Non_responder/FINAL_drug_ranking_Non_responder_evaluated.xlsx", sheet = 1, col_names = T))
old_lit2 <- old_lit2[,c(1,2,10:12)]
old_lit <- rbind(old_lit2[!is.na(old_lit2[,3]),], old_lit[!is.na(old_lit2[,3]),])
old_lit <- old_lit[! duplicated(old_lit[,1]),]
...
final_drug[final_drug[,3] == "FALSKT",3] <- F
final_drug[final_drug[,3] == "SANT",3] <- T
