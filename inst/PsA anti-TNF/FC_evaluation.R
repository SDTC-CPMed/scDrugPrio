...
#
# TEMPORARY !!!!!!!!!!!!!!!!!!!!!!!!!!
write.table(fc_evaluation, file = paste(out_dir, "SUMMARY_only_drugs_passing_network_criteria_part_1.txt",sep=""), sep="\t", col.names = T, row.names = F)
# TEMPORARY !!!!!!!!!!!!!!!!!!!!!!!!!!
#
# TEMPORARY !!!!!!!!!!!!!!!!!!!!!!!!!!
