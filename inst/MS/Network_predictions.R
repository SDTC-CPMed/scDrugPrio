...
degs <- as.matrix(read.table(file = "../Input/MS/DCA_MAST_DEGs_logFC_1.5_MS/TRANSLATED_ENTREZ_ID_sig_MAST_DEGs_log(1.5)_all_clusters.txt", header = T, stringsAsFactors = F, sep = "\t"))
if(nrow(degs)>1800){
  degs <- degs[1:1800,]
}
