...
datasource <- "Dress_PBMC" 

inputdir = paste0(getwd(),"data/DRESS NicheNet")
outputdir = paste(getwd(),"/Results/DRESS",sep="")
...
all_expressed_genes <- read.table(file = "./DRESS NicheNet/TRANSLATED_HGNC_SYMBOLS_background_genes_all_clusters_DCA_adj_data.txt", 
...
all_expressed_genes_DRESS <- all_expressed_genes

DEGs_human <- read.table(file="./DRESS NicheNet/TRANSLATED_HGNC_SYMBOL_sig_MAST_DEGs_log(1.5)_all_clusters.txt",
