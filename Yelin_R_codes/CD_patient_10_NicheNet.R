...
inputdir = paste0(getwd(),"data/Patient 10 NicheNet")
outputdir = paste(getwd(),"/Results/CD_P10",sep="")
...
all_expressed_genes <- read.table(file = "./Patient 10 NicheNet/TRANSLATED_HGNC_SYMBOLS_background_genes_all_clusters_DCA_adj_data.txt", 
...
all_expressed_genes_CD_P10 <- all_expressed_genes

DEGs_human <- read.table(file="./Patient 10 NicheNet/TRANSLATED_HGNC_SYMBOL_sig_MAST_DEGs_log(1.5)_all_clusters.txt",
