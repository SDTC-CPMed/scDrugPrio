...
datasource <- "UC_tissue"

inputdir = paste0(getwd(),"data/UC NicheNet")
outputdir = paste(getwd(),"/Results/UC",sep="")
...
all_expressed_genes <- read.table(file = "./UC NicheNet/TRANSLATED_HGNC_SYMBOLS_background_genes_all_clusters_DCA_adj_data.txt", 
...
all_expressed_genes_UC <- all_expressed_genes

DEGs_human <- read.table(file="./UC NicheNet/TRANSLATED_HGNC_SYMBOL_sig_MAST_DEGs_log(1.5)_all_clusters.txt",
