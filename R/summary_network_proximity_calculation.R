#' Creation of file used for manual evaluation of drug effect on the targeted genes
#' Counteraction of drug targets fold change is Used for drug candidate selection
#'
#' @param files character vector; full path and file name for files from seperate_unique_drug_target_combinations_into_individual_drugs().
...
#' @param drug_effect_data # first column = DrugBank ID, second = drug name, third = drug target, fourth = pharmacological effect on target
