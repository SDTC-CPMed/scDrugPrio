...
#' from B cell clusters, T cell clusters an  myeloid clusters respectivly (as identified in the original publication). To adhere to the GitHub file size restrictions, the full matrix was divided in six parts that are combined using the load_sample_data() function.
#'
#'
